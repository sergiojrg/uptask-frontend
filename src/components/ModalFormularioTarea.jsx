                                    ...
                                    >
                                        <div className='mb-5'>
                                            ...
                                            <input
                                                ...
                                                className='placholder-gray-400 rounded-md border w-full mt-2 p-2'
                                                value={nombre}
                                        ...
                                        <input
                                            type="submit"
                                            className='w-full p-2 bg-sky-600 text-sm hover:bg-sky-700 text-white font-bold uppercase cursor-pointer transition-colors rounded-md'
